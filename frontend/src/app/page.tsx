...
const rowSpan = ['row-span-1', 'row-span-2', 'row-span-3']
const country: any = {
  "IN": "+91",
  "US": "+1"
}
        ...
        <div className="p-10 flex flex-col justify-between">
          ...
          <div className="flex flex-col items-center justify-center">
            <div className="relative">
              <Image src={'/logo.png'} width={260} height={40} alt="logo" objectFit="contain" />
            </div>
            ...
            <form onSubmit={handleSubmit} className="w-full max-w-xs flex flex-col gap-4">
              ...
              <div className="w-full">
                <div className="w-full bg-[#D9D9D94D] flex items-center gap-1 px-2 rounded-md">
                  <select name="code" value={data.code} onChange={handleChange} className="outline-none w-14 bg-transparent">
